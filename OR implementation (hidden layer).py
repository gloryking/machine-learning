#OR Logic Gate implementation with hidden layer
...
for i in input_features:
  ...
  print("--------------------------------------------------------")
  print(output[0]," OR ",output[1]," = ",result4,"\tTarget Value = ",(output[0] or output[1]))
  print("\t\t\t\tERROR : ",(output[0] or output[1]) - result4)