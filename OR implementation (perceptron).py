# OR Logic Gate implementation (without hidden layer, only 1 perceptron)
...
for i in input_features:
  ...
  print("--------------------------------------------------------")
  print(output[0]," XOR ",output[1]," = ",result2,"\tTarget Value = ",(output[0] or output[1]))
  print("\t\t\t\tERROR : ",int(output[0] or output[1]) - result2)
